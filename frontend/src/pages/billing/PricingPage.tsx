...
export function PricingPage() {
  ...
  const status = overview?.subscription?.status as SubscriptionStatus | undefined;
  ...
  if (isPlansError) {
    return (
      <div className="space-y-6">
        ...
        <p className="text-sm text-red-600">Failed to load plans. Please try again later.</p>
      </div>
    );
  }
