...
import { MoreHorizontal, PlusCircle, UserPlus, Upload } from 'lucide-react';
...
export default function UsersList() {
  ...
  const columns: ColumnDef<User>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <span className="text-sm">{school?.name || 'N/A'}</span>
        );
      },
    },
    {
  ...
  if (isError) {
    return <div className="text-center text-destructive">Failed to load users.</div>;
  }
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              "{selectedUser?.firstName} {selectedUser?.lastName}" and all associated data.
            </DialogDescription>
          </DialogHeader>
