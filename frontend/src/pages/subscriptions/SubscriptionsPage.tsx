...
import { SubscriptionOverviewCard } from '@/components/subscriptions/SubscriptionOverviewCard';
...
export function SubscriptionsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Subscription Overview Card (for ADMIN users) */}
      {!isSuperAdmin && <SubscriptionOverviewCard />}

      {/* Subscription Management Table (for SUPER_ADMIN) */}
      {isSuperAdmin && (
        <>
          {/* Filters */}
          <Card>
