...
const billingAccountSchema = z.object({
  ...
  prefferedCurrency: z
    .string()
    .min(2, "Enter a preffered currency")
    .optional()
    .default("KES"),
});
...
export function CreateBillingAccountModal({
  ...
  const onSubmit = async (data: CreateBillingAccountInput) => {
    ...
    const finalSchoolId = isSuperAdmin
            ...
            {isSuperAdmin && (
              <div>
                ...
                <Select
                  ...
                  disabled={
                    !isSuperAdmin || isLoading || createMutation.isPending
                  }
                >
