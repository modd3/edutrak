// server/src/utils/grade-calculator.ts
...
export function calculateGrade(score: number, maxScore: number = 100): GradeScale {
  if (maxScore === 0) return GRADE_SCALES[GRADE_SCALES.length - 1];
